Spree Lizenzo Importer
==============

This extension adds import functionality for lizenzo products to Spree, with a bunch of features that give it similar functionality to Shopify's importer.
...
1. Add the gem to your Gemfile, and run bundle install.
    gem 'lizenzo_importer, :git => 'git://github.com/joshmcarthur/spree-import-products.git'
    bundle install
2. 'Install' the extension - copy a migration and an initializer
    rake lizenzo_importer:install
3. rake db:migrate
4. Configure the extension to suit your application by changing config variables in config/initializers/lizenzo_importer_settings.rb
5. Run application!
